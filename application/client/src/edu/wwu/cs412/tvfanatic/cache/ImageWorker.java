...
public abstract class ImageWorker {
     ...
     * is set immediately, otherwise an {@link CustomAsyncTask} will be created to asynchronously load the
     * bitmap.
     *
    ...
    public void loadImage(Object data, ImageView imageView) {
        ...
        if (bitmap != null) {
            ...
            // NOTE: This uses a custom version of LruAsyncTask that has been pulled from the
            // framework and slightly modified. Refer to the docs at the top of the class
            // for more info on what was changed.
            task.executeOnExecutor(CustomAsyncTask.DUAL_THREAD_EXECUTOR, data);
        }
    }
    ...
    /**
     * The actual LruAsyncTask that will asynchronously process the image.
     */
