...
package edu.wwu.cs412.tvfanatic.cache;
...
import edu.wwu.cs412.tvfanatic.BuildConfig;
...
public class ImageCache {
	...
	/**
	 * Find and return an existing ImageCache stored in a {@link RetainFragment}, if not found a new one is
	 * created using the supplied params and saved to a {@link RetainFragment}.
	 * 
	...
	/**
	 * Initializes the disk cache. Note that this includes disk access so this should not be executed on the
	 * main/UI thread. By default an ImageCache does not initialize the disk cache when it is created, instead
	 * you should call initDiskCache() to initialize it on a background thread.
	 */
	...
	/**
	 * Clears both the memory and disk cache associated with this ImageCache object. Note that this includes
	...
	/**
	 * Flushes the disk cache associated with this ImageCache object. Note that this includes disk access so
	...
	/**
	 * Closes the disk cache associated with this ImageCache object. Note that this includes disk access so
	 * this should not be executed on the main/UI thread.
	 */
	public void close() {
		synchronized (mDiskCacheLock) {
	...
	public static class ImageCacheParams {
		...
		/**
		 * Sets the memory cache size based on a percentage of the device memory class. Eg. setting percent to
		 * 0.2 would set the memory cache to one fifth of the device memory class. Throws
	...
	/**
	 * A simple non-UI Fragment that stores a single Object and is retained over configuration changes. It
	 * will be used to retain the ImageCache object.
	 */
